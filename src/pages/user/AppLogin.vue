<template>
    <div class="relative h-screen overflow-hidden flex flex-col items-center justify-center">
        ...
        <div class="w-full px-10">
            ...
            <div v-if="errorMessage" class="mb-4 p-3 rounded-md bg-red-50 text-red-600 text-sm font-semibold transition-all">
                {{ errorMessage }}
            </div>
            ...
            <div class="space-y-6">
                <div class="space-y-0.5">
                    ...
                    <div 
                        class="flex min-h-10 shadow rounded-md bg-white items-center border transition-colors"
